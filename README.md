...
- Docker installed
- Fork the https://github.com/kaitxq/devsecops-jenkins-scanner [repository](https://github.com/kaitxq/devsecops-jenkins-scanner) under your GitHub account, as you will need to make changes to the repository. Shortenurl - https://bit.ly/apr26
...
4. Modify the repository name: `find . -type f -exec sed -i "s/kaitxq/$YOURID/g" {} +`
...
```py
        ...
        codebuild_behave_image_build = codebuild.Project(
            ...
            source=codebuild.Source.git_hub(
                owner="kaitxq", repo="devsecops-jenkins-scanner", branch_or_ref=branch_or_ref
            ),
